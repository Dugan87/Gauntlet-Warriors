...
public class AIZombieState_Pursuit1 : AIZombieState
{
	...
	{ 
		...
		else 
		{
			...
			// Slowly update our rotation to match the nav agents desired rotation BUT only if we are not persuing the player and are really close to them
